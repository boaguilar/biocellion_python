...
class ModelWriter:
  ...
  '''
    ...
    def write_biomodel_files( self, biomodel, directory, source_directory ):
        ...
        for name in names:
            self.copy_file( directory, source_directory, name )
        
        self.write_biomodel_h( biomodel, directory, source_directory )
        self.write_biomodel_cpp( biomodel, directory, source_directory )
        self.write_config_xml( biomodel, directory, source_directory )
        return
